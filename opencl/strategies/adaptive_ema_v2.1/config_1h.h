...
#define SEARCH_PERCENT_SLOW_MULT_1H 0.2
#define SEARCH_PERCENT_ATR_1H 0.2
#define SEARCH_PERCENT_VOL_THRESHOLD_1H 0.03
#define SEARCH_PERCENT_ADX_LENGTH_1H 0.2
#define SEARCH_PERCENT_ADX_THRESHOLD_1H 0.12
