/**
 * Adaptive EMA with Volume Strategy v1 - 4H Configuration
 * 
 * Configuration for 4-hour timeframe optimization.
 */

#ifndef ADAPTIVE_EMA_VOL_V1_CONFIG_4H_H
#define ADAPTIVE_EMA_VOL_V1_CONFIG_4H_H
...
#define RSI_TRENDING_MIN_4H 40
#define RSI_TRENDING_MAX_4H 70
...
#define SEARCH_PERCENT_RSI_LENGTH_4H 0.15
#define SEARCH_PERCENT_RSI_TRENDING_MIN_4H 0.15
#define SEARCH_PERCENT_RSI_TRENDING_MAX_4H 0.10

#endif // ADAPTIVE_EMA_VOL_V1_CONFIG_4H_H
