...
#define SEARCH_PERCENT_EMA_FAST_BASE_1H 0.30     // 7-13
#define SEARCH_PERCENT_EMA_SLOW_BASE_1H 0.25    // 10-18  
#define SEARCH_PERCENT_ADX_LENGTH_1H 0.35        // 9-19
#define SEARCH_PERCENT_ADX_THRESHOLD_1H 0.40     // 9-21
#define SEARCH_PERCENT_RSI_LENGTH_1H 0.37        // 5-11
#define SEARCH_PERCENT_RSI_BUY_MAX_1H 0.13       // 62-82
#define SEARCH_PERCENT_RSI_SELL_MIN_1H 0.22      // 25-45
#define SEARCH_PERCENT_EFFICIENCY_LOOKBACK_1H 0.50  // 4-12
