/**
 * Adaptive EMA Strategy v2.2 - Configuration
 * 
 * This strategy uses adaptive EMAs with RSI and volume filters.
 * Features:
...
#ifndef ADAPTIVE_EMA_V2_2_CONFIG_H
#define ADAPTIVE_EMA_V2_2_CONFIG_H

// Strategy name and version
#define STRATEGY_NAME "Adaptive EMA v2.2"
#define STRATEGY_VERSION "v2.2"
...
typedef struct {
    ...
    // RSI settings
    int rsi_length;
    int rsi_threshold;  // Avoid entries if RSI > threshold (e.g., 70)
...
static const Strategy_1h_Config CONFIG_1H = {
    ...
    // RSI filter
    .rsi_length = 14,
    .rsi_threshold = 40,  // Only enter if RSI < 40 (avoid overbought)
...
#endif // ADAPTIVE_EMA_V2_2_CONFIG_H
