...
#define SEARCH_PERCENT_FAST_LOW_1H 0
#define SEARCH_PERCENT_SLOW_LOW_1H 0
#define SEARCH_PERCENT_FAST_MED_1H 0    
#define SEARCH_PERCENT_SLOW_MED_1H 0     
#define SEARCH_PERCENT_FAST_HIGH_1H 0    
#define SEARCH_PERCENT_SLOW_HIGH_1H 0    
#define SEARCH_PERCENT_ATR_1H 0
#define SEARCH_PERCENT_VOL_1H 0          
#define SEARCH_PERCENT_LOW_PCT_1H 0     
#define SEARCH_PERCENT_HIGH_PCT_1H 0
