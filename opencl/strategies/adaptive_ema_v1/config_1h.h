...
#define FAST_MED_1H 21
#define SLOW_MED_1H 101
...
#define VOL_LENGTH_1H 65
// BASE LOW_VOL_PCT_1H = 25, HIGH_VOL_PCT_1H = 75
#define LOW_VOL_PCT_1H 20
...
#define SEARCH_PERCENT_SLOW_LOW_1H 0.01
#define SEARCH_PERCENT_FAST_MED_1H 0.05    
#define SEARCH_PERCENT_SLOW_MED_1H 0.01     
#define SEARCH_PERCENT_FAST_HIGH_1H 0.02    
#define SEARCH_PERCENT_SLOW_HIGH_1H 0.01    
#define SEARCH_PERCENT_ATR_1H 0.2
#define SEARCH_PERCENT_VOL_1H 0.01          
#define SEARCH_PERCENT_LOW_PCT_1H 0.02      
#define SEARCH_PERCENT_HIGH_PCT_1H 0.01
