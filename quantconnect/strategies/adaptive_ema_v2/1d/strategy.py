...
class AdaptiveEMAV2_1D(BaseStrategy):
    """
    Adaptive EMA Strategy v2 - Daily Timeframe (1D)
    Optimized for daily bar trading
    ...
    def get_strategy_info(self) -> dict:
        ...
        return {
            'name': 'Adaptive EMA v2 - Daily (1D)',
            'description': 'EMA crossover with volatility-adaptive periods - Daily timeframe',
            'timeframe': '1D',
            'parameters': {
