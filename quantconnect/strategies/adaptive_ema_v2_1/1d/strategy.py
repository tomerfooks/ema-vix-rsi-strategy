"""
Adaptive EMA Strategy v2.1 - 1D Optimized
...
class AdaptiveEMAV2_1_1D(BaseStrategy):
    """
    Adaptive EMA Strategy v2.1 - 1D Optimized
    
    Parameters optimized for daily timeframe.
    """
    ...
    def get_strategy_info(self) -> dict:
        ...
        return {
            'name': 'Adaptive EMA v2.1 (1D)',
            'description': 'EMA crossover with volatility-adaptive periods and ADX confirmation (daily optimized)',
            'parameters': {
